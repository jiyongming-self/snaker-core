...
public interface DBAccess {
	 ...
	 * @return
	 */
	List<WfGroupPerson> getPersonByGoupId(String groupId);

	/**
	 * 获取流程实例的指定审核节点的实际审核人列表
	 * @param orderId
	 * @param taskNameList
	 * @return
	 */
    List<String> getRealOperatorList(String orderId, List<String> taskNameList);

	/**
	 * 删除历史任务
	 * @param hist
	 */
	void deleteHistTask(HistoryTask hist);

	/**
	 * 保存回调结果
	 * @param callbackLog
	 */
    void saveCallbackLog(CallbackLog callbackLog);
	 ...
	 * @return
	 */
	HistoryTask getFirstTask(String orderId);
	 ...
	 * @return
	 */
	HistoryTask getLastHistoryTaskByOrderId(String orderId);
}
