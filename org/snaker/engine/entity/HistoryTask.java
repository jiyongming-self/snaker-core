...
public class HistoryTask implements Serializable {
    ...
    private List<HistoryTaskActor> actorList;
    /**
     * 父任务Id
     */
    ...
    public HistoryTask(Task task) {
    	...
    	this.actionUrlType = task.getActionUrlType();
    ...
    public Task undoTask() {
    	...
    	task.setActionUrlType(this.getActionUrlType());
	...
	public List<HistoryTaskActor> getActorList() {
		return actorList;
	}

	public void setActorList(List<HistoryTaskActor> actorList) {
