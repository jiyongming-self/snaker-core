...
public class GeneralAccessStrategy implements TaskAccessStrategy {
	 ...
	 */
	public boolean isAllowed(String operator, List<TaskActor> actors, Map<String,Object> args) {
	...
	@Override
	public String canSkip(List<String> histOperatorList, String[] actors, String tenantId) {
		return null;
	}
}
