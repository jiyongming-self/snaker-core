...
import org.snaker.engine.scheduling.WfCallBack;
...
public class ProcessModel extends BaseModel {
	 ...
	 * 流程回调函数
	 */
	private WfCallBack callbackObject;
	...
	public WfCallBack getCallbackObject() {
		return callbackObject;
	}

	public void setCallbackUrl(String callbackStr) {
		if(StringHelper.isNotEmpty(callbackStr)) {
			this.callbackUrl = callbackStr;
			callbackObject = new WfCallBack();
