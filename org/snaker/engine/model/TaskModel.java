...
public class TaskModel extends WorkModel {
	 ...
	 * 表单类型：页面
	 */
	public static final String FORMTYPE_PAGE = "page";
	/**
	 * 表单类型：数据接口
	 */
	public static final String FORMTYPE_DATA = "data";
	/**
	 * 参与类型
	 */
	 ...
	 * 表单类型
	 */
	private String formType = FORMTYPE_PAGE;
	/**
	 * 期望完成时间
	 */
	...
	public void setAssigneeText(String assigneeText) {
	...
	public void setFormType(String formType) {
		this.formType = (StringHelper.isEmpty(formType) ? FORMTYPE_PAGE : formType);
	}
}
