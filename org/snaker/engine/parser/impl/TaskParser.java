...
public class TaskParser extends AbstractNodeParser {
	...
	protected void parseNode(NodeModel node, Element element) {
		...
		task.setFormType(element.getAttribute(ATTR_FORM_TYPE));
		...
		task.setAssigneeText(element.getAttribute(ATTR_ASSIGNEE_TEXT));
		task.setCanSkip(element.getAttribute(ATTR_CAN_SKIP));
